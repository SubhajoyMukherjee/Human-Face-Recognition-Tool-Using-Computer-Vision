...
Dataset_path='C:/Users/subha/Documents/GitHub/SubhajoyMukherjee/Human-Face-Recognition-Tool-Using-Computer-Vision/ImageDataSet_1.0'
...
#Image(pixel values in numpy array),top-left co-ordinate ,bottom-right co-ordinate of rectangle, color of rectangle(Red,Green, Blue values), Thickness of the rectangle line
    ...
    cv2.waitKey(1)
    if (cv2.waitKey(1) & 0xFF == ord('q')):  # Press 'q' form keyboard and press Enter to exit the loop
        break          
